...
const Product = () => {
  let { id } = useParams();
  const { allProducts, cartProducts, setCartProducts } = useContext(ProductsContext);
    ...
    <div className="product-page">
      <div className="main-product">
        ...
        <div className="main-product_info">
          ...
          <select className="main-product_info-amount" onChange={handleSelectChange}>
          ...
          <button onClick={addToCart} className="main-product_info-cart">Add to cart</button>
        </div>
      </div>
    </div>
  );
